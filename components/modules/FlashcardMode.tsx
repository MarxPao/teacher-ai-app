...
export default function FlashcardMode() {
 ...
 <div>
 <h1 style={{  textAlign: 'center', margin: '0', fontSize: '1.8rem', fontFamily: "'Fraunces', Georgia, serif", fontWeight: 700, color: paperTheme.textMain  }}>
...
function DeckListView({ decks, setDecks, onOpenDeck, onDelete, showToast }: any) {
 ...
 <h3 style={{ fontFamily: "'Fraunces', Georgia, serif", color: paperTheme.textMain }}>No decks found</h3>
 ...
 <h3 style={{ margin: '0 0 8px 0', fontSize: '18px', fontFamily: "'Fraunces', Georgia, serif", color: paperTheme.textMain }}>{deck.name}</h3>
...
function DeckDetailsView({ deck, updateDeck, onStudy, onGame, onMatching, showToast }: any) {
 ...
 <h2 style={{ margin: '0 0 20px 0', fontSize: '22px', fontFamily: "'Fraunces', Georgia, serif" }}>{deck.name}</h2>
 ...
 <h3 style={{ margin: '0 0 20px 0', fontSize: '20px', fontFamily: "'Fraunces', Georgia, serif" }}>Cards ({deck.cards.length})</h3>
 {deck.cards.length === 0 ? (
...
function StudyMode({ deck, updateDeck, onComplete }: any) {
 ...
 <button onClick={onComplete} style={{ marginTop: '40px', background: 'none', border: 'none', color: paperTheme.textMuted, cursor: 'pointer', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '14px' }}>Exit Study Mode</button>
 </div>
 );
}
...
function GameMode({ deck, students, onExit }: any) {
 ...
 return (
 <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: paperTheme.projectorBg, color: paperTheme.cardMain, zIndex: 9999, display: 'flex', flexDirection: 'column', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
 {/* Top Bar */}
 ...
 <div style={{ fontSize: '24px', fontWeight: 'bold', color: paperTheme.label, fontFamily: "'Fraunces', Georgia, serif" }}>{currentIndex + 1} / {cards.length}</div>
 ...
 {selectedStudent ? (
 <>
 <div style={{ fontSize: '32px', fontWeight: 'bold', color: paperTheme.label, fontFamily: "'Fraunces', Georgia, serif" }}>
...
function MatchingMode({ deck, onExit }: any) {
 ...
 <h2 style={{ margin: 0, fontFamily: "'Fraunces', Georgia, serif", color: paperTheme.textMain, fontSize: '28px' }}>Matching Game</h2>
 ...
 <h1 style={{  textAlign: 'center', color: paperTheme.success, fontSize: '48px', margin: '0 0 16px 0', fontFamily: "'Fraunces', Georgia, serif"  }}> You Won!</h1>
...
function Flashcard3D({ front, back, isFlipped, onClick, category }: any) {
 ...
 <h2 style={{ margin: 0, fontSize: '42px', textAlign: 'center', fontFamily: "'Fraunces', Georgia, serif", color: paperTheme.textMain }}>{front}</h2>

...
function buildExamPrompt(opts: {
 ...
 const methInstructions = buildMethodologyInstructions(opts.approach)
  ...
  ? `\n=== CONTEXTO DA BIBLIOTECA (BASE PEDAGÓGICA & TEMÁTICA) ===\n${opts.libraryContext.slice(0, 4500)}\n=== FIM DO CONTEXTO ===\nREGRA FUNDAMENTAL: O conteúdo da biblioteca acima deve ser usado estritamente como BASE DE CONTEÚDO, VOCABULÁRIO e CONCEITOS. NUNCA copie ou reproduza questões já prontas do material. Crie QUESTÕES 100% INÉDITAS, NOVAS E ORIGINAIS elaboradas a partir do assunto e nível gramatical presentes no material.\n`
  : ''

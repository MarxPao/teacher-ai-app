...
export default function PortalMirror() {
 ...
 setFillStatus(` A ponte da Extensão Chrome não está ativa. Para auto-preenchimento, abra o portal abaixo e instale a extensão Teacher AI no Chrome. Dados de ${studentsCount || 4} alunos foram preparados e estão prontos para envio.`)
 }
 setIsWorking(false)
 }

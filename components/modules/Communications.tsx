...
Gere o documento completo agora:`
 ...
 <h1 style={{  textAlign: 'center', fontFamily: "'Fraunces', Georgia, serif", fontSize: 30, fontWeight: 600, color: '#2c1a0e', margin: '0 auto'  }}>Comunicados</h1>
 </div>
 ...
 <label style={SL}> Informações</label>
 {[
 ...
 {factCheck.level === 'ok' ? ` Documento validado Qualidade ${factCheck.score}/100` : ` Revisar ${factCheck.issues.join('; ')}`}
 </span>
 </div>
 )}

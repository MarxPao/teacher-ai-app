...
export default function AudioPronunciation() {
 ...
 return (
 <div style={{ background: '#fdf8f2', minHeight: '100vh', padding: '36px 40px', fontFamily: "'Plus Jakarta Sans', sans-serif", color: '#2c1a0e' }}>
 ...
 <h1 style={{  textAlign: 'center', fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.8rem', fontWeight: 700, color: '#2c1a0e', margin: '0 auto'  }}>
 ...
 <select 
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: 200, boxSizing: 'border-box' }}
 value={selectedVoice}
 ...
 <select 
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: 150, boxSizing: 'border-box' }}
 value={pronRate}
 ...
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 16 }}>Word / Phrase Analysis</h2>
 <input 
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: '100%', boxSizing: 'border-box', marginBottom: 16 }}
 ...
 <button style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: '#8b5e3c', color: '#fffcf8', border: 'none', borderRadius: 9, fontSize: 13.5, fontWeight: 600, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', boxShadow: '0 2px 8px rgba(139,94,60,0.3)', transition: 'all 0.18s ease' }} onClick={() => speak(pronWord)}>
 <i className="ti ti-player-play-filled"></i> Listen
 </button>
 <button 
 style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '9px 18px', background: '#f5efe6', color: '#7a5c42', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, fontSize: 13.5, fontWeight: 500, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', transition: 'all 0.15s ease' }}
 onClick={() => {
 ...
 {/* Stress Visualizer */}
 <div style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.1)', borderRadius: 16, boxShadow: '0 2px 8px rgba(44,26,14,0.06)', padding: 28 }}>
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}><i className="ti ti-chart-bar" style={{ color: '#8b5e3c' }}></i> Word Stress Visualizer</h2>
 ...
 {/* Rhymes */}
 <div style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.1)', borderRadius: 16, boxShadow: '0 2px 8px rgba(44,26,14,0.06)', padding: 28 }}>
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}><i className="ti ti-music" style={{ color: '#8b5e3c' }}></i> Rhymes & Patterns</h2>
 ...
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.3rem', fontWeight: 600, color: '#2c1a0e', margin: 0 }}>Minimal Pair Trainer</h2>
 ...
 fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', transition: 'all 0.15s ease'
 }}
 ...
 <button style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '9px 18px', background: '#fffcf8', color: '#7a5c42', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, fontSize: 13.5, fontWeight: 500, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', marginTop: 24 }}>
 ...
 <button 
 style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '9px 18px', background: '#f5efe6', color: '#7a5c42', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, fontSize: 13.5, fontWeight: 500, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer' }}
 onClick={() => setMpIndex(i => (i > 0 ? i - 1 : MINIMAL_PAIRS.length - 1))}
 >
 <i className="ti ti-arrow-left"></i> Previous
 </button>
 <button 
 style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: '#8b5e3c', color: '#fffcf8', border: 'none', borderRadius: 9, fontSize: 13.5, fontWeight: 600, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', boxShadow: '0 2px 8px rgba(139,94,60,0.3)' }}
 onClick={() => {
 ...
 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 24 }}>
 <div style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.1)', borderRadius: 16, boxShadow: '0 2px 8px rgba(44,26,14,0.06)', padding: 28 }}>
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 8 }}>Dictation List</h2>
 <p style={{ color: '#a08060', fontSize: 13.5, marginBottom: 16 }}>Enter words or phrases, one per line.</p>
 <textarea
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: '100%', boxSizing: 'border-box', minHeight: 250, resize: 'vertical' }}
 value={dictationList}
 ...
 <div style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.1)', borderRadius: 16, boxShadow: '0 2px 8px rgba(44,26,14,0.06)', padding: 28 }}>
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 16 }}>Controls</h2>
 ...
 <button style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: '#8b5e3c', color: '#fffcf8', border: 'none', borderRadius: 9, fontSize: 13.5, fontWeight: 600, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', boxShadow: '0 2px 8px rgba(139,94,60,0.3)' }} onClick={handleDictationToggle}>
 ...
 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 24 }}>
 <div style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.1)', borderRadius: 16, boxShadow: '0 2px 8px rgba(44,26,14,0.06)', padding: 28 }}>
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 16 }}>Add to Word Bank</h2>
 <input 
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: '100%', boxSizing: 'border-box', marginBottom: 12 }} 
 placeholder="Word" 
 ...
 <select 
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: '100%', boxSizing: 'border-box' }}
 ...
 <textarea 
 style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.18)', borderRadius: 9, padding: '10px 14px', color: '#2c1a0e', fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13.5, outline: 'none', width: '100%', boxSizing: 'border-box', minHeight: 80, resize: 'vertical', marginBottom: 16 }} 
 placeholder="Notes / Example Sentence..."
 value={newBankWord.notes}
 onChange={e => setNewBankWord({...newBankWord, notes: e.target.value})}
 />
 <button style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: '#8b5e3c', color: '#fffcf8', border: 'none', borderRadius: 9, fontSize: 13.5, fontWeight: 600, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', boxShadow: '0 2px 8px rgba(139,94,60,0.3)', width: '100%', justifyContent: 'center' }} onClick={saveToBank}>
 <i className="ti ti-plus"></i> Add Word
 </button>
 </div>

 <div style={{ background: '#fffcf8', border: '1px solid rgba(139,115,85,0.1)', borderRadius: 16, boxShadow: '0 2px 8px rgba(44,26,14,0.06)', padding: 28 }}>
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.1rem', fontWeight: 600, color: '#2c1a0e', marginTop: 0, marginBottom: 16 }}>Saved Words ({wordBank.length})</h2>
 ...
 <div style={{ color: '#a08060', fontSize: 13, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
 ...
 <h2 style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.3rem', fontWeight: 600, color: '#2c1a0e', margin: 0 }}>Student Material Export</h2>
 <button style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: '#8b5e3c', color: '#fffcf8', border: 'none', borderRadius: 9, fontSize: 13.5, fontWeight: 600, fontFamily: "'Plus Jakarta Sans', sans-serif", cursor: 'pointer', boxShadow: '0 2px 8px rgba(139,94,60,0.3)' }} onClick={() => window.print()}>
 ...
 <h1 style={{  textAlign: 'center', fontFamily: "'Fraunces', Georgia, serif", margin: '0 auto', color: '#2c1a0e'  }}>Pronunciation Practice List</h1>
 <p style={{ color: '#7a5c42', margin: '0.5rem 0 0 0', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>TeacherAI Generated Material</p>
 </div>

...
### 1. Lacunas Críticas Detectadas (Gaps de Aprendizagem)
...
3. **Desafio de Extensão para os Top Performers**: Produção de mini-artigo argumentativo utilizando a estrutura do CLIL Lesson 3.`
 ...
 {stats.weakTopicsCount} Tópicos em Alerta
 </span>
 ...
 */}
 ...
 <div>
 <h3 style={{ margin: 0, fontFamily: "'Fraunces', Georgia, serif", fontSize: 18, color: '#2c1a0e' }}>
 ...
 <span style={{ fontSize: 15 }}>{isWeak ? '' : isStrong ? '' : ''}</span>
 <span>{row.topic}</span>
 </div>
 ...
 color: statusColor, fontWeight: 800, fontSize: 13, fontFamily: "'Fraunces', Georgia, serif"
 }}>
 {row.avgMastery}%
 </div>
 ...
 */}
 ...
 <span style={{ fontSize: 13, fontWeight: 800, color: Number(avg) < 6 ? '#c0392b' : '#27ae60', fontFamily: "'Fraunces', Georgia, serif" }}>
 {avg}
 </span>
 </div>
 ...
 <div>
 <h3 style={{ margin: 0, fontFamily: "'Fraunces', Georgia, serif", fontSize: 20, color: '#2c1a0e' }}>
 ...
 */}
 ...
 <h3 style={{ margin: 0, fontFamily: "'Fraunces', Georgia, serif", fontSize: 17, color: '#2c1a0e' }}>
 ...
 <div style={{ fontSize: 15, fontWeight: 800, color: '#c0392b', fontFamily: "'Fraunces', Georgia, serif" }}>
 {avg}
 </div>
 </div>
 )
 ...
 */}
 ...
 <div style={{ fontSize: 20, fontWeight: 800, color: '#2c1a0e', margin: '4px 0', fontFamily: "'Fraunces', Georgia, serif" }}>
 {lvl.count}
 </div>

...
const LineChart = ({ data }: { data: TimelineData[] }) => {
 ...
 {[50, 75, 100].map(val => (
 <g key={val}>
 <text x="0" y={getY(val)} fill="#a08060" fontSize="10" dominantBaseline="middle" fontFamily="'Plus Jakarta Sans', sans-serif">{val}</text>
 ...
 {/* X Axis Labels */}
 {data.map((d, i) => (
 <text key={i} x={getX(i)} y={height - 10} fill={theme.textMuted} fontSize="10" textAnchor="middle" fontFamily="'Plus Jakarta Sans', sans-serif">
 {d.month}
 </text>
 ))}
...
Responda APENAS um objeto JSON no formato:
{
 ...
 <h3 style={{ margin: '0 0 8px 0', fontSize: '16px', color: theme.warning, display: 'flex', alignItems: 'center', gap: '6px', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
 ...
 <h3 style={{ margin: '0 0 8px 0', fontSize: '16px', color: theme.success, display: 'flex', alignItems: 'center', gap: '6px', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
 ...
 <h3 style={{ margin: '0 0 16px 0', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '6px', fontFamily: "'Plus Jakarta Sans', sans-serif", color: '#2c1a0e' }}>

...
Gere um diagnóstico direto e 3 recomendações práticas para o professor decidir se deve avançar para a Unit 5 ou fazer 1 aula de reforço.`
 ...
 <div>
 <label style={{ fontSize: 12, fontWeight: 700, color: '#586e75', display: 'block', marginBottom: 4 }}> Ano Letivo</label>
 ...
 <h3 style={{ fontSize: 16, fontWeight: 700, margin: 0, fontFamily: "'Fraunces', Georgia, serif" }}>
 ...
 {isCompleted && (
 <span style={{ background: '#c4834a', color: '#fff', fontSize: 10, fontWeight: 800, padding: '3px 8px', borderRadius: 6, textTransform: 'uppercase' }}>
 Concluído
 </span>
 )}
 ...
 style={{ padding: '6px 12px', borderRadius: 8, border: '1px solid #e8e0d0', background: '#fff', fontSize: 12, fontWeight: 700, color: '#2c1a0e', cursor: 'pointer' }}
 >
 Detalhes da Unidade
 </button>
 </div>
 ...
 style={{ padding: '8px 16px', borderRadius: 8, border: 'none', background: '#c4834a', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}
 >
 Atualizar
 </button>
 </div>

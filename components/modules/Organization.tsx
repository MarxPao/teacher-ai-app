              ...
              <ModuleCard key={sch.id} padding={20}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                  ...
                  <div style={{ display: 'flex', gap: 6 }}>
                    <button onClick={() => openEditSchool(sch)} style={ActionIconButton} title="Editar">✏️</button>
                    <button onClick={() => deleteSchool(sch.id)} style={ActionIconButton} title="Excluir">🗑️</button>
                  </div>
                </div>
            ...
            return (
              <ModuleCard key={cls.id} padding={20}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                  ...
                  <div style={{ display: 'flex', gap: 6 }}>
                    <button onClick={() => openEditClass(cls)} style={ActionIconButton} title="Editar">✏️</button>
                    <button onClick={() => deleteClass(cls.id)} style={ActionIconButton} title="Excluir">🗑️</button>
                  </div>
                </div>
                <div style={{ fontSize: 12, color: '#665c54', display: 'flex', flexDirection: 'column', gap: 4 }}>
                ...
                return (
                  <tr key={st.id} style={{ borderBottom: '1px solid #f0e9df' }}>
                    ...
                    <td style={{ padding: '12px 16px', textAlign: 'right' }}>
                      <button onClick={() => openEditStudent(st)} style={ActionIconButton} title="Editar">✏️</button>
                      <button onClick={() => deleteStudent(st.id)} style={ActionIconButton} title="Excluir">🗑️</button>
                    </td>
                  </tr>
                )
              })}

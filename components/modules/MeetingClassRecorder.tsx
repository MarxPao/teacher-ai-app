...
Responda APENAS um objeto JSON estrito com o seguinte formato:
{
 ...
 <div style={{ color: theme.textLight, textAlign: 'center', padding: '2rem', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
 ...
 <h3 style={{fontFamily: "'Fraunces', Georgia, serif", margin: '0 0 8px 0'}}>Rafinha AI está analisando a gravação...</h3>
 ...
 <div>
 <h2 style={{margin: '0 0 8px 0', fontFamily: "'Fraunces', Georgia, serif", fontSize: '1.5rem'}}>{record.title}</h2>

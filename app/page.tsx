...
const TestAndWorksheets     = dynamic(() => import('@/components/modules/TestAndWorksheets'),     { loading: () => <ModuleSkeleton />, ssr: false })
const LessonStudio          = dynamic(() => import('@/components/modules/LessonStudio'),          { loading: () => <ModuleSkeleton />, ssr: false })
const LessonPlanner         = dynamic(() => import('@/components/modules/LessonPlanner'),         { loading: () => <ModuleSkeleton />, ssr: false })
const Rubric                = dynamic(() => import('@/components/modules/Rubric'),                { loading: () => <ModuleSkeleton />, ssr: false })
const Gradebook             = dynamic(() => import('@/components/modules/Gradebook'),             { loading: () => <ModuleSkeleton />, ssr: false })
const Students              = dynamic(() => import('@/components/modules/Students'),              { loading: () => <ModuleSkeleton />, ssr: false })
const Classes               = dynamic(() => import('@/components/modules/Classes'),               { loading: () => <ModuleSkeleton />, ssr: false })
const OmniGrader            = dynamic(() => import('@/components/modules/OmniGrader'),            { loading: () => <ModuleSkeleton />, ssr: false })
const Analytics             = dynamic(() => import('@/components/modules/Analytics'),             { loading: () => <ModuleSkeleton />, ssr: false })
const Repository            = dynamic(() => import('@/components/modules/Repository'),            { loading: () => <ModuleSkeleton />, ssr: false })
const Settings              = dynamic(() => import('@/components/modules/Settings'),              { loading: () => <ModuleSkeleton />, ssr: false })
const ApiManager            = dynamic(() => import('@/components/modules/ApiManager'),            { loading: () => <ModuleSkeleton />, ssr: false })
const ComingSoon            = dynamic(() => import('@/components/modules/ComingSoon'),            { loading: () => <ModuleSkeleton />, ssr: false })
const Planner               = dynamic(() => import('@/components/modules/Planner'),               { loading: () => <ModuleSkeleton />, ssr: false })
const QuestionBank          = dynamic(() => import('@/components/modules/QuestionBank'),          { loading: () => <ModuleSkeleton />, ssr: false })
const MindMap               = dynamic(() => import('@/components/modules/MindMap'),               { loading: () => <ModuleSkeleton />, ssr: false })
const Editor                = dynamic(() => import('@/components/modules/Editor'),                { loading: () => <ModuleSkeleton />, ssr: false })
const Communications        = dynamic(() => import('@/components/modules/Communications'),        { loading: () => <ModuleSkeleton />, ssr: false })
const Portfolio             = dynamic(() => import('@/components/modules/Portfolio'),             { loading: () => <ModuleSkeleton />, ssr: false })
const Maestro               = dynamic(() => import('@/components/modules/Maestro'),               { loading: () => <ModuleSkeleton />, ssr: false })
const ClassLog              = dynamic(() => import('@/components/modules/ClassLog'),              { loading: () => <ModuleSkeleton />, ssr: false })
...
const AttendanceList        = dynamic(() => import('@/components/modules/AttendanceList'),        { loading: () => <ModuleSkeleton />, ssr: false })
const Wellbeing             = dynamic(() => import('@/components/modules/Wellbeing'),             { loading: () => <ModuleSkeleton />, ssr: false })
const AudioPronunciation    = dynamic(() => import('@/components/modules/AudioPronunciation'),    { loading: () => <ModuleSkeleton />, ssr: false })
const ReflectivePractice    = dynamic(() => import('@/components/modules/ReflectivePractice'),    { loading: () => <ModuleSkeleton />, ssr: false })
const MeetingClassRecorder  = dynamic(() => import('@/components/modules/MeetingClassRecorder'),  { loading: () => <ModuleSkeleton />, ssr: false })
const WeeklyAgenda          = dynamic(() => import('@/components/modules/WeeklyAgenda'),          { loading: () => <ModuleSkeleton />, ssr: false })
const BatchGrader           = dynamic(() => import('@/components/modules/BatchGrader'),           { loading: () => <ModuleSkeleton />, ssr: false })
const ProgressTracker       = dynamic(() => import('@/components/modules/ProgressTracker'),       { loading: () => <ModuleSkeleton />, ssr: false })
const AutoReport            = dynamic(() => import('@/components/modules/AutoReport'),            { loading: () => <ModuleSkeleton />, ssr: false })
const Organization          = dynamic(() => import('@/components/modules/Organization'),          { loading: () => <ModuleSkeleton />, ssr: false })
const PrivateTutoring       = dynamic(() => import('@/components/modules/PrivateTutoring'),       { loading: () => <ModuleSkeleton />, ssr: false })
const Eventos               = dynamic(() => import('@/components/modules/Eventos'),               { loading: () => <ModuleSkeleton />, ssr: false })
